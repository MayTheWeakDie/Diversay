/**
 * MagicWand01Icon — exact component from @hugeicons-animated/magic-wand-01
 * Source: https://hugeicons-animated.com/r/magic-wand-01.json
 * Ported from TSX to JSX for this project.
 */
...
const MagicWand01Icon = forwardRef(
  ({ onMouseEnter, onMouseLeave, className, size = 28, autoPlay = false, ...props }, ref) => {
    ...
    const activeAnimate = autoPlay ? 'animate' : controls;
